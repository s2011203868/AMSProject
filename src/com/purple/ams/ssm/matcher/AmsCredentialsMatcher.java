package com.purple.ams.ssm.matcher;
 ...
 */
public class AmsCredentialsMatcher extends HashedCredentialsMatcher {

    private Cache<String,AtomicInteger> passwordRetryCache;
    
     
     public AmsCredentialsMatcher(CacheManager cacheManager) {
